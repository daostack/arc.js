...
*Defined in [types.ts:3](https://github.com/daostack/client/blob/77afecd/src/types.ts#L3)*
...
*Defined in [types.ts:4](https://github.com/daostack/client/blob/77afecd/src/types.ts#L4)*
...
*Defined in [utils.ts:60](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L60)*
...
*Defined in [types.ts:5](https://github.com/daostack/client/blob/77afecd/src/types.ts#L5)*
...
*Defined in [types.ts:21](https://github.com/daostack/client/blob/77afecd/src/types.ts#L21)*
...
*Defined in [proposal.ts:840](https://github.com/daostack/client/blob/77afecd/src/proposal.ts#L840)*
...
*Defined in [operation.ts:39](https://github.com/daostack/client/blob/77afecd/src/operation.ts#L39)*
...
*Defined in [types.ts:7](https://github.com/daostack/client/blob/77afecd/src/types.ts#L7)*
...
*Defined in [types.ts:6](https://github.com/daostack/client/blob/77afecd/src/types.ts#L6)*
...
*Defined in [operation.ts:41](https://github.com/daostack/client/blob/77afecd/src/operation.ts#L41)*
...
*Defined in [utils.ts:7](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L7)*
...
*Defined in [settings.ts:5](https://github.com/daostack/client/blob/77afecd/src/settings.ts#L5)*
...
*Defined in [arc.ts:16](https://github.com/daostack/client/blob/77afecd/src/arc.ts#L16)*
...
*Defined in [settings.ts:6](https://github.com/daostack/client/blob/77afecd/src/settings.ts#L6)*
...
*Defined in [utils.ts:158](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L158)*
...
*Defined in [settings.ts:2](https://github.com/daostack/client/blob/77afecd/src/settings.ts#L2)*
...
*Defined in [settings.ts:4](https://github.com/daostack/client/blob/77afecd/src/settings.ts#L4)*
...
*Defined in [utils.ts:6](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L6)*

*Defined in [arc.ts:17](https://github.com/daostack/client/blob/77afecd/src/arc.ts#L17)*
...
*Defined in [utils.ts:17](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L17)*
...
*Defined in [utils.ts:48](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L48)*
...
▸ **createApolloClient**(`options`: object): *ApolloClient‹object›*

*Defined in [graphnode.ts:26](https://github.com/daostack/client/blob/77afecd/src/graphnode.ts#L26)*
...
*Defined in [utils.ts:187](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L187)*
...
*Defined in [schemes/contributionReward.ts:37](https://github.com/daostack/client/blob/77afecd/src/schemes/contributionReward.ts#L37)*
...
*Defined in [schemes/contributionReward.ts:61](https://github.com/daostack/client/blob/77afecd/src/schemes/contributionReward.ts#L61)*
...
*Defined in [utils.ts:62](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L62)*
...
*Defined in [utils.ts:9](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L9)*
...
*Defined in [utils.ts:160](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L160)*
...
*Defined in [utils.ts:39](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L39)*
...
*Defined in [utils.ts:67](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L67)*
...
*Defined in [genesisProtocol.ts:18](https://github.com/daostack/client/blob/77afecd/src/genesisProtocol.ts#L18)*
...
*Defined in [utils.ts:152](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L152)*
...
*Defined in [operation.ts:60](https://github.com/daostack/client/blob/77afecd/src/operation.ts#L60)*
...
*Defined in [operation.ts:168](https://github.com/daostack/client/blob/77afecd/src/operation.ts#L168)*
...
*Defined in [utils.ts:13](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L13)*
...
*Defined in [utils.ts:81](https://github.com/daostack/client/blob/77afecd/src/utils.ts#L81)*
...
*Defined in [schemes/contributionReward.ts:33](https://github.com/daostack/client/blob/77afecd/src/schemes/contributionReward.ts#L33)*

*Defined in [schemes/genericScheme.ts:23](https://github.com/daostack/client/blob/77afecd/src/schemes/genericScheme.ts#L23)*

*Defined in [schemes/schemeRegistrar.ts:22](https://github.com/daostack/client/blob/77afecd/src/schemes/schemeRegistrar.ts#L22)*

*Defined in [proposal.ts:23](https://github.com/daostack/client/blob/77afecd/src/proposal.ts#L23)*

*Defined in [proposal.ts:29](https://github.com/daostack/client/blob/77afecd/src/proposal.ts#L29)*

###  ContributionReward

• **ContributionReward**: = "ContributionReward"

*Defined in [schemes/contributionReward.ts:34](https://github.com/daostack/client/blob/77afecd/src/schemes/contributionReward.ts#L34)*

###  GenericScheme

• **GenericScheme**: = "GenericScheme"

*Defined in [schemes/genericScheme.ts:24](https://github.com/daostack/client/blob/77afecd/src/schemes/genericScheme.ts#L24)*

###  SchemeRegistrarAdd

• **SchemeRegistrarAdd**: = "SchemeRegistrarAdd"

*Defined in [schemes/schemeRegistrar.ts:23](https://github.com/daostack/client/blob/77afecd/src/schemes/schemeRegistrar.ts#L23)*

###  SchemeRegistrarEdit

• **SchemeRegistrarEdit**: = "SchemeRegistrarEdit"

*Defined in [schemes/schemeRegistrar.ts:24](https://github.com/daostack/client/blob/77afecd/src/schemes/schemeRegistrar.ts#L24)*

###  SchemeRegistrarRemove

• **SchemeRegistrarRemove**: = "SchemeRegistrarRemove"

*Defined in [schemes/schemeRegistrar.ts:25](https://github.com/daostack/client/blob/77afecd/src/schemes/schemeRegistrar.ts#L25)*
